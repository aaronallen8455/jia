...
//require user to be admin or have ownership of this venue
if ((isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] === true) || (isset($_SESSION['venuesOwned']) && in_array($_GET['id'], $_SESSION['venuesOwned']))) {
    require MYSQL;
